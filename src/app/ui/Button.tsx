...
export const Button = ({
  ...
  const appearanceButton = {
    ...
    redEmpty:    "rounded m-1 grow text-md py-2 px-12 border-2 border-red-400 text-red-400 bg-white/50 hover:bg-red-200/50 hover:text-red-700 hover:border-red-700", 
  }
